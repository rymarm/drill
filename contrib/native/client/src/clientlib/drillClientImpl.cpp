...
DrillClientQueryResult* DrillClientImpl::SubmitQuery(::exec::shared::QueryType t,
    ...
    boost::function<DrillClientQueryResult*(const int32_t&)> factory = boost::bind(
...
DrillClientPrepareHandle* DrillClientImpl::PrepareQuery(const std::string& plan,
    ...
    boost::function<DrillClientPrepareHandle*(const int32_t&)> factory = boost::bind(
...
DrillClientCatalogResult* DrillClientImpl::getCatalogs(const std::string& catalogPattern,
    ...
    boost::function<DrillClientCatalogResult*(const int32_t &)> factory = boost::bind(
...
DrillClientSchemaResult* DrillClientImpl::getSchemas(const std::string& catalogPattern,
    ...
    boost::function<DrillClientSchemaResult*(const int32_t &)> factory = boost::bind(
...
DrillClientTableResult* DrillClientImpl::getTables(const std::string& catalogPattern,
    ...
    boost::function<DrillClientTableResult*(const int32_t &)> factory = boost::bind(
...
DrillClientColumnResult* DrillClientImpl::getColumns(const std::string& catalogPattern,
    ...
    boost::function<DrillClientColumnResult*(const int32_t &)> factory = boost::bind(
...
Handle* DrillClientImpl::sendMsg(boost::function<Handle*(const int32_t&)> handleFactory, ::exec::user::RpcType type, const ::google::protobuf::Message& message) {
    int32_t coordId;
    Handle* phandle=NULL;
...
meta::DrillMetadata* DrillClientImpl::getMetadata() {
	...
	boost::function<DrillClientServerMetaHandle*(const int32_t&)> factory = boost::bind(
